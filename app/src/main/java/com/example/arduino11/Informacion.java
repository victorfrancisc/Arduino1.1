...
public class Informacion extends AppCompatActivity {
   ...
   Rutas ruta=new Rutas();
                ...
                try {
                    ...
                    if (row.length() > 0) {
                        for (int p = 0; p < row.length(); p++) {
                            ...
                            datouno = Integer.valueOf(aux.get("opcion1").toString());
    ...
    public void grafico(int uno, int dos) {
      ...
      textViewince.setText(String.valueOf(uno));
        ...
        pieEntries.add(new PieEntry(uno, "Monóxido"));
        pieEntries.add(new PieEntry(dos, "Temperatura"));
        PieDataSet pieDataSet = new PieDataSet(pieEntries,null);
        PieData pieData = new PieData(pieDataSet);
        piechart.setData(pieData);
        pieDataSet.setColors(Color.parseColor("#ffff00"), Color.parseColor("#76ff03"));
